...
def handle_message(message):
  ...
  if user_state == "waiting_for_uid":
    ...
    if uid in submitted_uids:
      bot.send_message(
          chat_id, "❌ এই ফেসবুক UID টি ইতিমধ্যে একবার জমা দেওয়া হয়েছে!"
      )
    else:
  ...
  # ৩. টাস্ক সাবমিশন প্রসেস: অ্যাকাউন্ট খোলা শেষ বাটন
    ...
    if text == "অ্যাকাউন্ট খোলা শেষ":
      ...
      bot.send_message(
          chat_id,
          "দয়া করে নিচের **'অ্যাকাউন্ট খোলা শেষ'** অথবা **'❌ বাতিল'** বাটনে"
          " ক্লিক করুন।",
      )
    return
  ...
  if text == "💰 ব্যালেন্স":
    ...
    reply_text = (
        ...
        f" BDT\n👥 রেফারেল ইনকাম: {ref_income:.2f} BDT\n\n✅ সম্পন্ন কাজ: {completed}"
    ...
    bot.send_message(
        chat_id, "✏️ যেকোনো একটি কাজ সিলেক্ট করুন নিচে:", reply_markup=markup
    )
    ...
    support_markup.add(
        types.InlineKeyboardButton(
            "📢 অফিসিয়াল চ্যানেল", url="https://t.me/R4_Work_Sapait"
        )
    )
...
if __name__ == "__main__":
  # ফ্লাস্ক সার্ভার ব্যাকগ্রাউন্ড থ্রেডে চালু করা হচ্ছে
